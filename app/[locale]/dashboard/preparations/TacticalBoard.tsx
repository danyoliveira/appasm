...
export default function TacticalBoard({
  ...
  const [videoUrl, setVideoUrl] = useState(editingSnapshot?.videoUrl ?? "");
  // The parent keys this component by editingSnapshot's id (remounting it
  // whenever which snapshot is being edited changes), so these only ever
  // need to reflect the snapshot this instance was mounted with — no effect
  // needed to keep them in sync as the prop changes underneath.
