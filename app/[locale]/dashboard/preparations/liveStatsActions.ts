...
// Guest links never expire and (until now) could never be swapped out —
// leak one (wrong WhatsApp group, forwarded by mistake) and it stayed live
// forever. Same token format as the DB default (gen_random_bytes(16) as
